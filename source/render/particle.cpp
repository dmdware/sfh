...
void DefineParticle(int32_t i, char* texpath, int32_t del, float dec, Vec3f minV, Vec3f maxV, Vec3f minA, Vec3f maxA, float minS, float maxS, void (*collision)(Particle* part, Billboard* billb, Vec3f trace, Vec3f normal))
{
...
{
#if 1
	//void Particle(int32_t i, char* texpath, int32_t del, float dec, Vec3f minV, Vec3f maxV, Vec3f minA, Vec3f maxA, float minS, float maxS, void (*collision)(Particle* part, Billboard* billb, Vec3f trace, Vec3f normal))
...
void EmitParticle(int32_t type, Vec3f pos)
{
	int32_t i = NewParticle();
	if(i < 0)
		return;
