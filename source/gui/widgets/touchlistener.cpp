...
TouchListener::TouchListener(Widget* parent, const char* name, void (*reframef)(Widget* w), void (*click2)(int32_t p), void (*overf2)(int32_t p), void (*out)(), int32_t parm) : Widget()
{
	m_parent = parent;
	m_type = WIDGET_TOUCHLISTENER;
	m_over = false;
