...
public:
	...
	TextArea(Widget* parent, const char* n, const RichText t, int32_t f, void (*reframef)(Widget* w), float r=1, float g=1, float b=1, float a=1, void (*change)()=NULL);
