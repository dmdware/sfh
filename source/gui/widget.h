...
public:
	...
	void (*clickfunc)();
	void (*clickfunc2)(int32_t p);
	void (*overfunc)();
	void (*overfunc2)(int32_t p);
	void (*outfunc)();
	void (*changefunc)();
	void (*changefunc2)(int32_t p);
	...
	virtual void hide();
	virtual void show();
	virtual void chcall(Widget* ch, int32_t type, void* data);	//child callback
