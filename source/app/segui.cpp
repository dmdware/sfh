...
void Click_CompileRunMap()
{
	...
	ofn.nMaxFileTitle = WF_MAX_PATH;	//0;
...
{
#ifdef PLATFORM_WIN
	memset(filepath, 0, sizeof(char)*WF_MAX_PATH);
...
void FillGUI2()
{
	...
	logoview->add(new Image(NULL, "logo", "gui/dmd.jpg", true, Resize_AppLogo, 1,1,1,0));
